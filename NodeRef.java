...
public class NodeRef implements org.apache.thrift.TBase<NodeRef, NodeRef._Fields>, java.io.Serializable, Cloneable, Comparable<NodeRef> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NodeRef");
  ...
  static {
    schemes.put(StandardScheme.class, new NodeRefStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NodeRefTupleSchemeFactory());
  }
  ...
  public NodeRef setIp(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NodeRef)
      return this.equals((NodeRef)that);
    return false;
  }

  public boolean equals(NodeRef that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NodeRef(");
    boolean first = true;
  ...
  private static class NodeRefStandardSchemeFactory implements SchemeFactory {
    public NodeRefStandardScheme getScheme() {
      return new NodeRefStandardScheme();
    }
  }

  private static class NodeRefStandardScheme extends StandardScheme<NodeRef> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NodeRef struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NodeRef struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class NodeRefTupleSchemeFactory implements SchemeFactory {
    public NodeRefTupleScheme getScheme() {
      return new NodeRefTupleScheme();
    }
  }

  private static class NodeRefTupleScheme extends TupleScheme<NodeRef> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NodeRef struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeRef struct) throws org.apache.thrift.TException {
